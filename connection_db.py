...
# Obtener variables de entorno con valores por defecto para pruebas locales
...
POSTGRESQL_ADDON_PORT = os.getenv('POSTGRESQL_ADDON_PORT', '5432')  # Usamos 5432 como estándar
